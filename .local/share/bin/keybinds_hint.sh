...
tmpMapDir="/tmp"
tmpMap="$tmpMapDir/my-keybinds.jq"
keycodeFile="${myConfDir}/keycode.kb"
modmaskFile="${myConfDir}/modmask.kb"
keyFile="${myConfDir}/key.kb"
categoryFile="${myConfDir}/category.kb"
dispatcherFile="${myConfDir}/dispatcher.kb"
